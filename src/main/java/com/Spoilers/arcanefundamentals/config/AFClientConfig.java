...
public class AFClientConfig {
    ...
    public static void init(ForgeConfigSpec.Builder clientConfig) {
        ...
        clientConfig.pop();
        /*
         * clientConfig.comment("Arcane Fundamentals // Monocle Settings").push(
         * "af_monocle_settings"); DISPLAY_SOULS = clientConfig.
         * comment("Should the mana monocle display the souls of undead faction players"
         * ).define("display_souls", true); ELEMENT_RENDER_DISTANCE =
         * clientConfig.comment("Render distance for entity mana display").defineInRange
         * ("render_distance", 16, 8, 64); ELEMENT_SIZE =
         * clientConfig.comment("Size of the mana display").defineInRange(
         * "display_size", 0.4, 0.0, 8.0); ELEMENT_HEIGHT = clientConfig.
         * comment("Height of the mana display in blocks, relative to entity head").
         * defineInRange("display_height", 0.22, -8.0, 8.0); ELEMENT_OFFSET =
         * clientConfig.
         * comment("Horizontal offset of the mana display in blocks, negative values move right"
         * ).defineInRange("display_offset", 0.0, -8.0, 8.0);
         */
    }
}
