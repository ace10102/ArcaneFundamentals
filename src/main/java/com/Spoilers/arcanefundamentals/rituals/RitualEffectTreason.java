...
public class RitualEffectTreason extends RitualEffect {
	...
	protected boolean applyRitualEffect(IRitualContext context) {
		...
		context.getWorld().playSound(null, context.getCenter().getX(), context.getCenter().getY(), context.getCenter().getZ(), playHornSound(playerFac), SoundCategory.PLAYERS, 1.0f, (float)(0.9f + 0.2f * Math.random()));
		
		RitualUtilityEntity ritualHandler = new RitualUtilityEntity(context.getWorld(), this.getRegistryName().toString(), context.getCenter().asLong(), traitor, playerTier);
		...
		switch (playerFac) {
			...
			case ANCIENT_WIZARDS: 
				replaceArtifact = playerTier == 5 ? new ResourceLocation("mana-and-artifice:faction_horn_council") :
					new ResourceLocation("mana-and-artifice:ley_line_bracelet");
				replaceMark = new ResourceLocation("mana-and-artifice:mark_of_the_council");
				replaceMote = new ResourceLocation("mana-and-artifice:enchantment_focus_arcane");
			...
			case DEMONS: 
				...
				replaceMote = new ResourceLocation("mana-and-artifice:enchantment_focus_fire");
			...
			case FEY_COURT: 
				...
				replaceMote = new ResourceLocation("mana-and-artifice:enchantment_focus_air");
			...
			case UNDEAD: 
				...
				replaceMote = new ResourceLocation("mana-and-artifice:enchantment_focus_ender");
