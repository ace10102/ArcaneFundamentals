...
import com.Spoilers.arcanefundamentals.blocks.VinteumPowder;
...
public class RegistryHandler {
    ...
    public static final RegistryObject<Item> WAKEBLOOM_SEED = ITEMS.register("wakebloom_seed", () -> new WakebloomSeedItem(RegistryHandler.WAKEBLOOM_CROP.get(), new Item.Properties().group(ArcaneFundamentals.TAB)));
    	//Other
    public static final RegistryObject<Item> ITEM_VINTEUM_POWDER = ITEMS.register("item_vinteum_powder", () -> new BlockItem(RegistryHandler.VINTEUM_POWDER.get(), new Item.Properties().group(ArcaneFundamentals.TAB)));
