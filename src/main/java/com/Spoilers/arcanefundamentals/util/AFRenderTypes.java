...
public class AFRenderTypes extends RenderType {
	...
	public static final VertexFormat POSITION_TEX_NORMAL_LIGHTMAP = new VertexFormat(
			ImmutableList.<VertexFormatElement>builder().add(ELEMENT_POSITION).add(ELEMENT_UV0).add(ELEMENT_NORMAL).add(ELEMENT_UV2).add(ELEMENT_PADDING).build());
